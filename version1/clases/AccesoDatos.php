...
class AccesoDatos
{
    ...
    private function __construct()
    {
        try {
            ...
            $this->_objetoPDO = new PDO('mysql:host=localhost;dbname=id2357769_juegos;charset=utf8', 'id2357769_juegos', '17811781', array(PDO::ATTR_EMULATE_PREPARES => false,PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
